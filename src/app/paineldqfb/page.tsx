  ...
  return (
    <>
      ...
      {/* (Story 2.66 / AC7) Card "Uso esparso de aparelhos" — a série que o cron
          ...
          🔴 O JSX vive em `./uso-esparso-card`, e isso é o conserto de F-2.66-02: enquanto
          o card era inline, a guarda que protegia o conserto do achado do CodeRabbit lia
          este arquivo como TEXTO — e a `@qa` a derrubou pondo o defeito no JSX e as frases
          num comentário. Como componente, o card é RENDERIZADO no teste e as asserções são
          sobre o DOM, onde comentário não entra.
